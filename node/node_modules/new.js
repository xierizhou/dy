tac='i)69yzkbltrs!i#x2ms"0,<8~z|\x7f@QGNCJF[\\^D\\KFYSk~^WSZhg,(lfi~ah`{md"inb|1d<,%Dscafgd"in,8[xtm}nLzNEGQMKAdGG^NTY\x1ckgd"inb<b|1d<g,&TboLr{m,(\x02)!jx-2n&vr$testxg,%@tug{mn ,%vrfkbm[!cb|';
function getdytk(){
	return '4830f6e279a5f53872aab9e9dc112d33';
}
function getuid(){
	return '57720812347';
}
